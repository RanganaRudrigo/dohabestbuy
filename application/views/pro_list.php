    ...
    <div id="breadcrumb" class="clearfix">
        <div class="container">
            ...
            <div class="breadcrumb clearfix">
                ...
                <?php endif; ?>
                <span  class="navigation-pipe">&gt;</span> <?= $menu ?>
            </div>
            <!-- /Breadcrumb -->
        ...
        <div class="container">
            <div class="row">
                ...
                <section id="center_column" class="col-md-9">
                    ...
                    <h1 class="page-heading product-listing"> <span class="cat-name"> <?= $menu ?>&nbsp; </span> </h1>
                                ...
                                <div class="product-container product-block" itemscope itemtype="">
                                    <div class="left-block">
                                        ...
                                        <div class="product-image-container image">
                                            ...
                                            <a class="product_img_link" href="<?= current_url() ?>/<?= url_title($pro->title)  ?>/<?= $pro->id ?>" title="" itemprop="url">
                                        ...
                                        <div class="box-buttons">
                                            ...
                                            <div class="view"> <a itemprop="url" class="lnk_view button btn-tooltip" href="<?= current_url() ?>/<?= url_title($pro->title)  ?>/<?= $pro->id ?>" title="View"> <i class="fa fa-search"></i> </a> </div>
                                        </div>
                                    </div>
                                    <div class="right-block">
                                        <div class="product-meta">
                                            ...
                                            <h5 itemprop="name" class="name"> <a class="product-name" href="<?= current_url() ?>/<?= url_title($pro->title)  ?>/<?= $pro->id ?>" title=" <?= $pro->title ?> " itemprop="url" > <?= $pro->title ?> </a> </h5>
