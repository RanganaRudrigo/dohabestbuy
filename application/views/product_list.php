...
<head>
    ...
    <style>
        ...
        div.scott a:hover, div.scott a:active {
            border: 1px solid #340149;
			color: #C279C6;
			background-color: #E1C4E2;
        }
            ...
            <div class="row">
                ...
                <section id="left_column" class="column sidebar col-md-3">
                    ...
                    <div id="categories_block_left" class="block block-highlighted">
                        <h4 class="title_block"> <?= $mainmenu->title ?> </h4>
                        <div class="block_content">
                            <ul class="list-block list-group bullet tree dhtml">
                                <?php foreach($category as $cat ): ?>
                                    <?php if($cat->id == $mainmenu->id ): ?>
                                        <?php foreach($cat->sub as $sub ): ?>
                                            <li>
                                                <a class="<?= $sub->id == $menu->id ? "current" : "" ?>" href="<?= base_url()."shop/".url_title($cat->title)?>/<?=$cat->id?>/<?=url_title($sub->title)?>/<?=$sub->id?>" title="<?= $sub->title ?>">
                                                    <?= $sub->title ?> <span id="leo-cat-52"   class="leo-qty badge pull-right"><?=  $sub->count ?></span> </a>
                                            </li>
                                        <?php endforeach; ?>
                                    <?php break; endif; ?>
                                <?php endforeach; ?>
                    ...
                    <div id="informations_block_left_1" class="block informations_block_left">
                        ...
                        <div class="block_content list-block">
                            <ul>
                                <li> <a href="<?=base_url()?>Delivery-Information" title="Delivery Information">Delivery Information</a> </li>
                                <li> <a href="<?=base_url()?>Warranty" title="Warranty"> Warranty </a> </li>
                                <li> <a href="<?=base_url()?>Terms-and-Condition" title="Terms & Condition"> Terms & Condition </a> </li>
                                <li> <a href="<?=base_url()?>About-us" title="About us"> About us </a> </li>
                                <li> <a href="<?=base_url()?>Security" title="Secure Payments"> Secure Payments </a> </li>
                ...
                <section id="center_column" class="col-md-9">
                    <div class="content_scene_cat">
                        ...
                        <div class="content_scene_cat_bg scene_cat">
                            <div class="image"> <img class="img-responsive" src="<?= base_url() ?>uploads/<?= $menu->banner ?>" alt="<?= $menu->title ?>  " title="<?= $menu->title ?>" id="categoryImage"  /> </div>
                            <div class="cat-desc">
                    ...
                    <h1 class="page-heading product-listing"> <span class="cat-name"> <?= $menu->title ?>&nbsp; </span> </h1>
                                ...
                                <div class="product-container product-block" itemscope itemtype="">
                                    ...
                                    <div class="right-block">
                                        <div class="product-meta">
                                            ...
                                            <!-- @file modules\appagebuilder\views\templates\front\products\name -->
                                            <h5 itemprop="name" class="name"> <a class="product-name" href="<?= base_url()."product_detail/".$link ?>/<?= url_title($pro->title)  ?>/<?= $pro->id ?>" title=" <?= $pro->title ?> " itemprop="url" > <?= $pro->title ?> </a> </h5>
                                            ...
                                            <div class="content_price">
                                                <?php if($pro->discount > 0  ): ?>
                                                    <span    class="price product-price"> <?= number_format( round( (100-$pro->discount)/100 * $pro->price ) , 2 ) ?> QAR </span> <br/> 
                                                    <span    class="old-price product-price">  <?= number_format($pro->price ,2) ?> QAR </span>
                                                    <span class="price-percent-reduction">-<?=round($pro->discount)  ?>%</span>
                                                <?php else: ?>
                                                    <span    class="price product-price"> <?= number_format($pro->price ,2) ?> QAR </span> 
...
$(window).load(function() {
  equalheight('.product_list .ajax_block_product');
}); 
