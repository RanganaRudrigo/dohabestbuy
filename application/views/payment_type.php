                ...
                <div id="order-detail-content" class="table_block table-responsive">
                    <table id="cart_summary" class="table table-bordered stock-management-on">
                        ...
                        <tr class="cart_total_price">
                            ...
                            <td colspan="2" class="price" id="total_product"><?= $this->cart->format_number($this->cart->total() )?> QAR</td>
                        </tr>
                        ...
                        <tr class="cart_total_delivery">
                            ...
                            <td colspan="2" class="price" id="total_shipping" > <?= curreny($this->session->userdata("shipping_amount") ) ?> QAR</td>
                        </tr>
                        ...
                        <tr class="cart_total_price">
                            ...
                            <td colspan="2"   class="price" id="total_price_container"> <span id="total_price"><?= $this->cart->format_number($this->cart->total()+ $this->session->userdata("shipping_amount")  )?> QAR</span> </td>
                        </tr>
                        </tfoot>
                        <tbody>
