<style>
  ...
  .foot-1 { margin-top:6px; float:left;}
  .space-top-50 p { float:left;}
...
.block_content1 { margin-top:10px;}
</style>
          ...
          <div class="block_content">
            <form action="" onsubmit="return subscribe.init()" method="post">
              <div class="form-group" >
                <input class="inputNew form-control grey newsletter-input" id="newsletter-input" required type="email" name="email" size="18" placeholder="Enter your e-mail" />
                <button type="submit"   class="btn button button-small"> <i class="fa fa-arrow-right"></i> </button>
              </div>
            </form>
          </div>
        </div>
	...
	<div class="footer-block block" id="block_various_links_footer">
		<h4 class="title_block">About Company</h4>
		 <ul class="toggle-footer list-group bullet">
            ...
            <li class="item"> <a href="<?=base_url()?>Terms-and-Condition" title=""> Terms & Condition </a> </li>
...
<div class="footer-block block">
	...
	<div class="block_content toggle-footer">
		 <ul class="toggle-footer list-group bullet">
            ...
            <li class="item"> <a href="<?=base_url()?>Quality" title=""> Quality &amp; Customer review</a> </li>
            <li class="item"> <a href="<?=base_url()?>Security" title=""> Security </a> </li>
            <li class="item"> <a href="<?=base_url()?>Delivery-Information" title=""> Delivery Information </a> </li> 
          </ul>
	</div>
</div>
<!-- /Block myaccount module -->
...
<div class="footer-block block">
	...
	<div class="block_content toggle-footer">
		 <address class="space-top-50">
              ...
              <span class="text-uppercase black foot-1" >Exfast Online Computer Technology.</span>
               <p>#04, Block No 15, Floor No: 01, Sheikh Faisal <br/> Al Thani Bldg  Al Garafa, Doha, Qatar.</p> 
               <p>Tele: +974-44 671 790 / Hotline +974-3088 0088</p>
               <p style="line-height:28px;">Email :info@dohabestbuy.com <br/>
			   Web : <a href="https://dohabestbuy.com" target="_blank">www.dohabestbuy.com</a>
			   </p> 
...
<div 
    class="ApHtml block">
	<span id="siteseal"><img src="<?=base_url()?>images/footer_logo_1.png"/>&nbsp;&nbsp;&nbsp;<script type="text/javascript" src="https://seal.starfieldtech.com/getSeal?sealID=xl1YCdJbMZzOcwgwUH4rByd7dutqDrYMMmaDbcesfm2cfIs96yqsT61XGcxL"></script>&nbsp;&nbsp;&nbsp;<img src="<?=base_url()?>images/footer_logo_2.png"/></span>
    	<div class="block_content1">
            <p class="copyright">Copyright &copy; <?=date("Y")?> Dohabestbuy.com - All rights reserved By Exfast Online Computer Technology. Powered by <a href="http://itmart.lk/" target="_blank">IT MARTX</a></p>
          </div>
